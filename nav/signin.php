...
<html>
     ...
     <div class="container d-flex justify-content-center align-items-center" style="min-height:100vh">
               <form class="border shadow p-3 rounded" action="register.php" method="post" style="width:450px;">
                    ...
                    <div class="mb-3">
                         <label for="fanlocid" class="form-label">Fan/Location ID</label>
                         <input type="text" class="form-control" name="fanlocid" id="exampleInputEmail1">
                    </div>
                    <div class="mb-3">
                         <label for="username" class="form-label">Email</label>
                         <input type="email" class="form-control" name="username" id="exampleInputPassword1" required>
                    </div>
                    <div class="mb-3">
